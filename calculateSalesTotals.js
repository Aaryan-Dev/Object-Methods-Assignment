...
function calculateSalesTotals(sales){
    ...
    let arr = [];
      for(i=0; i<sales.length; i++){
       ...
       item : sales[i].item,
       oringinal : sales[i].original,
       sale : sales[i].original,
        stock : sales[i].stock,
          total :  sales[i].original*sales[i].stock
          }
        arr.push(obj);
        } else {
       ...
       item : sales[i].item,
       oringinal : sales[i].original,
       sale : sales[i].original - sales[i].original*sales[i].discount,
        stock : sales[i].stock,
          total : ( sales[i].original - sales[i].original*sales[i].discount)*sales[i].stock
          }
           arr.push(obj);
        }
      }
